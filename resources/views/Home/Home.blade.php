...
<head>
  ...
  <link href="assetsNew/styles/smile.min.css" rel="stylesheet">
    ...
    <div class="hero-content overlay-mobile">
      <div class="hero-message">
        <div class="hero-text-right">
          ...
          <p style="color:#000000;"><b>es tener un amigo inseparable, Smartbar</b></p>
          <!-- Buttons -->
<<<<<<< HEAD
...
>>>>>>> d311274fc6d5462b9226bf180c1e15e42be4ac3a
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="block-content text-center">
      ...
      <div class="row cards-basic">
        <div class="col bg-gray-white">
            <img class="grayscale" src="assetsNew/images/user-monica.png" alt="Monica Tatiana" />
            ...
            <a class="button small lemon" href="https://twitter.com/monicaricand/status/623601139259428868" target="_blank" rel="nofollow">Ver testimonio</a>
        </div>
        <div class="col bg-gray-white">
            <img class="grayscale" src="assetsNew/images/user-monica.png" alt="Monica Tatiana" />
            <h3>Carlos Monsalve</h3>
            <p>Desde que cuento con Smartbar, tomo mejores desiciones, y mi negocio a crecido más rápido de lo que algun avez soñe, definitivamente, nunca me puede faltar, Smartbar.</p>
            <a class="button small lemon" href="https://twitter.com/carlos_storms/status/619544447131496448" target="_blank">Ver testimonio</a>
        </div>
        <div class="col bg-gray-white">
            <img class="grayscale" src="assetsNew/images/user-monica.png" alt="Monica Tatiana" />
            <h3>Mauricio Burbano</h3>
            <p>Smartbar es un Excelente aplicativo... Una herramienta muy fácil y dinámica para conocer el estado actual de la organización. Me gusta mucho.</p>
            <a class="button small lemon" href="https://twitter.com/MAUROBURBANO/status/542699505729425408" target="_blank" rel="nofollow">Ver testimonio</a>
        </div>
        <div class="col bg-gray-white">
            <img class="grayscale" src="assetsNew/images/user-monica.png" alt="Monica Tatiana" />
            <h3>BarNight</h3>
            <p>Mis empleados tienen más claro lo que tienen que hacer, tienen todas las herramientas a la mano y yo soy menos indispensable, nunca pense tener tanto tiempo libre, y mi negocio creciendo a pasos agigantados.</p>
            <a class="button small lemon" href="https://twitter.com/Mi_almacen/status/514238039632388096" target="_blank" rel="nofollow">Ver testimonio</a>
        </div>
      </div>
...
<!-- logos -->
<section class="block bg-gris-Cla">
