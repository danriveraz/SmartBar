...
<section class="block" data-name="Users">
    <div class="block-content text-center">
      ...
      <input type="checkbox" class="read-more-state" id="post-1" />
        ...
        <div class="col bg-gray-white">
            <img class="grayscale" src="{{asset('assets-home/images/testimonios/user-monica2.png')}}" alt="" />
            <h3>Alvaro Diaz</h3>
      <input type="checkbox" class="read-more-state" id="post-2" />
        ...
        <div class="col bg-gray-white">
            <img class="grayscale" src="{{asset('assets-home/images/testimonios/user-monica3.png')}}" alt="" />
            <h3>BlankAndWhite</h3>
