...
<section class="block" data-name="Plans">
  <div class="block-content text-center">
    ...
    <div class="row plans cards-basic">
      <div class="col plan bg-gray-white" id="unica" style="display: none;">
          ...
          <ul>
            ...
            <p> 10% descuento en pago trimestral. </p>
          </ul>
          <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
            <input type="hidden" name="cmd" value="_s-xclick">
            <input type="hidden" name="hosted_button_id" value="YEUTK66UGQZ8W">
            <table align="center">
              <tr>
                <td>
                  <input type="hidden" name="on0" value="Duracion">Duracion
                </td>
              </tr>
              <tr>
                <td>
            ...
            <br>
            <button class="btn btn-bitbucket" border="0" name="submit" alt="PayPal, la forma rápida y segura de pagar en Internet."> 
              Suscribirse
            </button> 
          </form>
      </div>
      <div class="col plan bg-gray-white" id="especial" style="display: none;">
      ...
      <div class="col plan bg-gray-white" id="elite" style="display: none;">
          ...
          <ul>
              ...
              <p>Descuento en membresia de $ 198.000 Cop</p>
          </ul>
      </div>
    </div>
