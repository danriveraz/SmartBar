...
<body> 
	<div class="welcome">
		<div class="container" margin-right="auto">
			...
			<div class="col-sm-4" id="caja" align="center">{{$nombreMesa}}</div>
			<div class="col-sm-4"></div>
			<br><br>	
			<div class="col-sm-4"></div>
			<div class="col-sm-4">
			<form name="formulario" autocomplete="on" method="post" action="{{url('bartender/')}}">
				...
				@foreach($pedidos as $pedido)
					<table id="tabla" class="table table-bordered">
						<tbody>
							<tr>
								<td rowspan="2" align="center" valign="center" width="20">Cantidad:<br>{{$pedido->cantidad}}</td>
								<td align="center" valign="center">{{$pedido->categoria}}</td>
								<td rowspan="2" align="center" valign="center" width="10">
									<br><input type="checkbox" name="pedidos[]" value="{{$pedido->id}}">
								</td>
							</tr>
							<tr>
								<td align="center" valign="center">{{$pedido->nombre}}	</td>
							</tr>	 
						</tbody>
					</table>
				@endforeach
