						    ...
						    <ul>
								...
								<li class="login" >
									<div id="loginContainer" ><a href="#" id="loginButton"><span>Iniciar Sección</span></a>
						                <div id="loginBox">
						                    <form id="loginForm" method="post" action="<?php echo e(url('auth/login')); ?>">
						                        ...
						                        <span><a href="<?php echo e(url('/auth/register')); ?>">¿Adquiere Tu Cuenta?</a></span>
						                    </form>
						                </div>
						               </div>
								   </li>
                ...
                <article><p>Ten el control de tu establecimiento desde cualquier lugar.</p> <img src="images/clouds.png"  alt="" /> </article>
            		...
            		<div class="dropdown-buttons">
				     ...
				     <div class="quote_button">
                 		 ...
                 		 <div class="quote_button">
                  	 		<a class="" href="<?php echo e(url('auth/register')); ?>">Registrarse</a>
                 				 </div>
              				</div>
          				</div>
