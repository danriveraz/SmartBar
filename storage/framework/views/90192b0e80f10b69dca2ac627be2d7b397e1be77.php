						...
						<div id="register" class="animate w3layouts agileits form">
							...
							<div class="text-danger">
								 ...
								 <?php endif; ?>
                                	...
                                	<label>Empresa</label>
									<input type="text" class="name w3layouts agileits" name="nombreEstablecimiento" value="<?php echo e(old('nombreEstablecimiento')); ?>" >
									<div class="text-danger"><?php echo e($errors->first('nombreEstablecimiento')); ?></div>
                                <div class="left-w3-agile">
                                    <label>Nombre</label>
									<input type="text" class="usuario w3layouts agileits" name="nombrePersona" placeholder="" value="<?php echo e(old('name')); ?>" ><div class="text-danger"><?php echo e($errors->first('name')); ?></div>
									</div>	
