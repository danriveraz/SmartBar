...
<div class="col-sm-offset-2 col-sm-8">
          ...
          <div class="panel panel-default">
              <div class="panel-heading">
                  <h4 class="panel-title">
                      <a data-toggle="collapse" data-parent="#accordion" href=<?php echo e("#collapse".$categoria->id); ?>><?php echo e($categoria->nombre); ?></a>
                  </h4>
              </div>
              <div id=<?php echo e("collapse".$categoria->id); ?> class="panel-collapse collapse">
                  <div class="panel-body">
                    ...
                    <?php foreach($categoria->productos as $producto): ?>
                      <tr>
                        ...
                        <td>
                          <button class="btn btn-success" onclick="actualizarTabla(<?php echo e($producto->id); ?>)" >
  ...
  <button onclick="enviarDatos(<?php echo e($factura->id); ?>)" id="botonEnviar" class="btn btn-default"><i class="fa fa-plus"></i>Enviar pedido</button>
  <?php endforeach; ?>
</div>
