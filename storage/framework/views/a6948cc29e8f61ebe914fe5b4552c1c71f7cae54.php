...
<div class="col-sm-offset-3 col-sm-6">
  ...
  <a href="<?php echo e(route('auth.insumo.create')); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Agregar nuevo insumo </a>
  <?php echo Form::model(Request::all(), ['route' => ['auth.insumo.index'], 'method' => 'GET', 'class' => 'navbar-form navbar-right']); ?>
    ...
    <tbody>
      <?php foreach($insumos as $insumo): ?>
        <tr>
          ...
          <td><a href="<?php echo e(route('auth.insumo.edit',$insumo->id)); ?>" class="btn btn-warning"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span></a>
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>
